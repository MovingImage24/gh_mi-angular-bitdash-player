...
export namespace UIManager.Factory {
  ...
  export function buildAudioVideoUI(player: PlayerAPI, config: UIConfig = {}): UIManager {
  ...
  export function buildAudioOnlyUI(player: PlayerAPI, config: UIConfig = {}): UIManager {
