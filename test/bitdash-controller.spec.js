...
describe('BitdashController', function () {
  ...
  it('should configure the player with vmpro HLS URL', function() {
  ...
  it('should configure the player with offset', function() {
  ...
  it('should configure the player with offset and existing query string', function() {
    $scope.webcast.postliveStateData.playout.offset = 10;
  ...
  it('should configure the player in DVR with offset', function() {
    $scope.webcast.useDVRPlaybackInPostlive = true;
    $scope.webcast.postliveStateData.playout.offset = 10;
    var vm = createController();
